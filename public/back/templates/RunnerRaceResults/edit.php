...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $runnerRaceResult->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $runnerRaceResult->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="runnerRaceResults form content">
            ...
            <fieldset>
                <legend><?= __('Edit Runner Race Result') ?></legend>
                <?php
